...
public class 게임플레이2 {
    ...
    public static void main(String[] args) {
        ...
        생명체 생명체값 = new 생명체();
        아이템 아이템들 = new 아이템();
        살점 오렌지살점 = new 살점("4.오렌지좀비의 살점", 0, 1);
        살점 짜장면살점 = new 살점("5.짜장면좀비의 살점", 0, 1);
        살점 먹물살점 = new 살점("6.먹물파스타좀비의 살점", 0, 1);
        ...
        while (true) {
                        ...
                        while (true) {
                            ...
                            // ------------------------------- 2.아이템 공격 ---------------------------------
                                ...
                                if (오렌지살점.갯수 >= 1) {
                                    ...
                                    System.out.print("              ");
                                    아이템들.살점아이템(오렌지살점.품명,오렌지살점.갯수);

                                } if (짜장면살점.갯수 >= 1) {

                                    System.out.print("              ");
                                    아이템들.살점아이템(짜장면살점.품명,짜장면살점.갯수);

                                } if (먹물살점.갯수 >= 1) {

                                    System.out.print("              ");
                                    아이템들.살점아이템(먹물살점.품명,먹물살점.갯수);
                                }
                                System.out.println("\n           Tip : 살점아이템을 사용하면 그\n" +
                                                   "                 살점의 좀비로 변신합니다.");
                                System.out.println("          ╚════════════════════════════════╝");
                                ...
                                if (스킬써 == 4) {
                                    ...
                                    // 살점 차감 값 넣음
                                    int 살점써 = 아이템들.살점갯수감소(오렌지살점.갯수);
                                    오렌지살점.갯수 = 살점써;
                                    System.out.println(오렌지살점.품명+" 아이템을 사용합니다.");
                                    System.out.println("남은 "+오렌지살점.품명+"의 갯수 : "+오렌지살점.갯수+"개\n");

                                } else if (스킬써 == 5) {

                                    아이템들.살점갯수감소(짜장면살점.갯수);
                                    System.out.println("남은 "+짜장면살점.품명+"의 갯수 : "+짜장면살점.갯수+"개\n");

                                } else if (스킬써 == 6) {

                                    아이템들.살점갯수감소(먹물살점.갯수);
                                    System.out.println("남은 "+먹물살점.품명+"의 갯수 : "+먹물살점.갯수+"개\n");
                                    ...
                                    //공격시행. 감소된 체력 값 넣기
                                    int 공격결과to좀 = 생명체값.스킬공격(당신이름, 오렌지좀비값.이름, 오렌지좀비값.스킬명,
                                            오렌지좀비값.스킬대사, 생존자설정값.공격력,
                                            오렌지좀비값.남은체력);
                                    오렌지좀비값.남은체력 = 공격결과to좀;
                                ...
                                if (오렌지좀비값.남은체력 > 0) {
                                    ...
                                    for (int 경험치=0; 경험치<=10000; 경험치+=1000){
                                        ...
                                        if (생존자설정값.경험치 >= 경험치 && 생존자설정값.경험치 + 오렌지좀비값.경험치 <= 경험치+1000) {
                                            ...
                                            System.out.println( "                     현재 레벨 : "+생존자설정값.레벨+"\n" +
                                                                "                     현재 경험치 : "+생존자설정값.경험치+"\n");
            ...
            // 3. 지하 전당포
                ...
                while (true) {
                    ...
                    System.out.println("[ " + 당신이름 + " ] 님이 지하 전당포에 입장합니다.");
                    ...
                    if (당신의선택_상점123 == 1) {
                        ...
                        while (true) {
                            ...
                            아이템들.상점_구매(생존자설정값.소지골드, 아이템들.품명, 아이템들.갯수);
                            ...
                            if (당신의선택_상점_구매 == 1) {
                                ...
                                if (부품1.가격 > 생존자설정값.소지골드) {
                                    ...
                                    System.out.println(부품1.품명 + "를 구매했습니다.");
                                    System.out.println("내 쌈짓돈에서 -"+부품1.가격+"원 차감됩니다.\n");
                    ...
                    // 2.판매
                        ...
                        while (true) {
                            ...
                            System.out.println("\n=========== 내 배낭 ===========\n");
                            if (부품1.갯수 >= 1) {
                                아이템들.판매아이템(부품1.품명,부품1.가격, 부품1.갯수);
                            }
                            if (부품2.갯수 >= 1) {
                                아이템들.판매아이템(부품2.품명,부품2.가격, 부품2.갯수);
                            }
                            if (부품3.갯수 >= 1) {
                                아이템들.판매아이템(부품3.품명, 부품3.가격, 부품3.갯수);
                            }
...
/*
            ...
            // 4. 내 배낭
                ...
                if (부품1.갯수 >= 1) {
                    ...
                    아이템들.판매아이템(오렌지살점.품명,0,오렌지살점.갯수);
                } if (짜장면살점.갯수 >= 1) {
                    아이템들.판매아이템(짜장면살점.품명,0,짜장면살점.갯수);
                } if (먹물살점.갯수 >= 1) {
                    아이템들.판매아이템(먹물살점.품명,0,먹물살점.갯수);
                }
                System.out.println( "\n\n" +
                                    "╔══════════════════════╗\n" +
                                    "        현재 소지금      \n" +
        ...
        }  //~while "1.사냥  2.상태확인  3.지하 전당포  4.내 배낭  5.퀘스트
