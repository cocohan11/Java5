...
*//*
                            ...
                            //-------------------------- 스레드 -------------------------------
                            Runnable r = new 좀비스레드2(생존자값, 좀비값);  //빵꾸 2개 뚫었더니 main에서 선언한 객체값 가져옴!!! 야호
...
*//*
                            ...
                            if (좀비값.남은체력 > 0 && 생존자값.남은체력 > 0) {
                                ...
                                while (좀비값.남은체력 > 0 && 생존자값.남은체력 > 0) {
                                    ...
                                    //lose하면 여기로 돌아와서 press any number해줘야됨.. 어떻게 고치지? if로 전체를 감싸도 안 됨.
*/
/*
...
*//*
                                    ...
                                    if (좀비값.남은체력 < 좀비값.기존체력 / 2) {

                                        System.out.println("\n" +
                                                "                                                                  " +
                                                " 화난 좀비가 날뛴다! " +
                                                "\n\n\n\n");
                                        System.out.println("[" + 당신이름 + "]은 도망다니느라 2초간 공격이 느려진다.");
                                        Thread.sleep(2000);

                                    }


                                    int 사냥 = 입력값.nextInt();  //내가 죽으면 여기에 머물러있구나
...
*/
/*
                                    System.out.println("좀비의 남은체력1 : " + 좀비값.남은체력);
*//*
...
/*
                                        ...
                                        if (좀비값.남은체력 < 좀비값.기존체력/2) {
                                            ...
                                            System.out.println("                화난 좀비가 날뛴다! ");
                                            System.out.println("["+당신이름+"]은 2초간 도망다니느라 공격이 느려진다.");
                                            Thread.sleep(2000);
...
*//*
                                    ...
                                    //공격값이 300(일반공격)인지 900(아이템)인지에 따라 나오는 화면을 다르게 설정함
                                    if (생존자값.공격력 == 300) {
                                    ...
                                    } else if (생존자값.공격력 == 900) {


                                        int 아이템공격 = 입력값.nextInt();
...
*//*
                            ...
                            if (생존자값.남은체력 > 0) {
                                ...
                                생존자값.공격력 = 300;  //아이템쓰고나서 900으로 남은 문제 해결하기 위해 쓴 코드.
                            ...
                            //생존자 사망
                                ...
                                if (게임종료 == 1) {
                                    ...
                                    System.out.println("무료 회복을 원하시면 \"치료해주세요\"라고 입력하세요.");
                                    System.out.println("유료 회복을 원하시면 1을 누르세요( 10만원 )\n");
                                    //가독성위해 \n
                                    ...
                                    if (사망후생존자체력.equals(num)) {
                                        ...
                                        생존자값.남은체력 = 1;
                                        System.out.println("다친 몸을 이끌고 돌아갑니다.. \n\n\n");
